...
public class FireBlockFlowing extends FireBlockFluid {
		...
		if (l > 0) {
			...
			if (i1 == l) {
				...
				if (i1 < 0) {
					...
					par1World.setBlock(par2, par3, par4, this.blockID, i1, 2);
					par1World.scheduleBlockUpdate(par2, par3, par4,
							this.blockID, this.tickRate(par1World));
		...
		for (int k1 = 0; k1 < 4; ++k1) {
			if ((k1 != 0 || par6 != 1) && (k1 != 1 || par6 != 0)
				...
				if (!this.blockBlocksFlow(par1World, l1, par3, i2)
						&& (par1World.getBlockMaterial(l1, par3, i2) != this.blockMaterial || par1World
	...
	private boolean[] getOptimalFlowDirections(World par1World, int par2,
		...
		for (l = 0; l < 4; ++l) {
			...
			if (!this.blockBlocksFlow(par1World, i1, par3, j1)
					&& (par1World.getBlockMaterial(i1, par3, j1) != this.blockMaterial || par1World
							.getBlockMetadata(i1, par3, j1) != 0)) {
				if (this.blockBlocksFlow(par1World, i1, par3 - 1, j1)) {
					this.flowCost[l] = this.calculateFlowCost(par1World, i1,
							par3, j1, 1, l);
				} else {
					this.flowCost[l] = 0;
				}
	...
	private boolean blockBlocksFlow(World par1World, int par2, int par3,
		...
		if (l != Block.doorWood.blockID && l != Block.blockIron.blockID
