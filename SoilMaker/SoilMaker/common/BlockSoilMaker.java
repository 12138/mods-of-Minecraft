...
public class BlockSoilMaker extends BlockContainer {
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return SoilMaker.soilMaker.blockID;
	}
	...
	public Icon getIcon(int par1, int par2) {
		return par1 == 1 ? this.up : (par1 == 0 ? this.down
				: (par1 == 3 ? this.front : this.blockIcon));
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3,
		...
		if (par1World.isRemote) {
			...
			TileEntitySoilMaker var10 = (TileEntitySoilMaker) par1World
					.getBlockTileEntity(par2, par3, par4);

			if (var10 != null) {
				par5EntityPlayer.openGui(SoilMaker.instance, 0, par1World,
						par2, par3, par4);
			}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4,
		...
		if (par6ItemStack.hasDisplayName()) {
			((TileEntitySoilMaker) par1World.getBlockTileEntity(par2, par3,
					par4)).func_94129_a(par6ItemStack.getDisplayName());
		}
	}
