...
Random ran=new Random();
	...
	public void updateTick(World par1World, int par2, int par3, int par4,
		...
		List list=Jimmynator.proxy.findTarget(par1World,AxisAlignedBB.getBoundingBox(par2-5.0D,par3-5.0,par4-5.0D,par2+5.0D,par3+5.0,par4+5.0), null);
	...
	public void registerIcons(IconRegister par1IconRegister) {
		for(int i=0;i<6;i++)
			this.iconArray[i]=par1IconRegister.registerIcon("Jimmynator:wheat_"+i);
	}
