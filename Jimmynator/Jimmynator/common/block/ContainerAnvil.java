...
import Jimmynator.client.gui.SlotAnvil;
import Jimmynator.client.gui.SlotAnvilHammer;
import Jimmynator.common.Jimmynator;
import Jimmynator.common.anvil.AnvingManager;
import Jimmynator.common.anvil.InventoryAnvResult;
import Jimmynator.common.anvil.InventoryAnvil;
...
public class ContainerAnvil extends Container {
	  ...
	  public ContainerAnvil(InventoryPlayer inventoryplayer, World world, int i, int j, int k)
	  {
	    ...
	    for (int l = 0; l < 3; l++)
	    {
	      ...
	      {
	    	 this.addSlotToContainer(new Slot(this.anvilMatrix, k1 + l * 5, 12 + k1 * 18, 17 + l * 18));
	      }
	    ...
	    for (int l1 = 0; l1 < 3; l1++)
	    {
	      ...
	      {
	    	  this.addSlotToContainer(new Slot(inventoryplayer, k2 + l1 * 9 + 9, 8 + k2 * 18, 84 + l1 * 18));
	      }
	    }
...
@Override
	  ...
	  {
	    if (this.worldObj.getBlockId(this.posX, this.posY, this.posZ) != Jimmynator.blockAnvil.blockID)
	    {
	      return false;
	    }
