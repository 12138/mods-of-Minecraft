...
private int itemDamage;
    ...
    public EntityTomahawk(World par1World, ItemStack itemstack,EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
	...
	public void onUpdate() {
        ...
        else
        {
            ...
            if (movingobjectposition != null && movingobjectposition.entityHit != null && movingobjectposition.entityHit instanceof EntityPlayer)
            {
                ...
                if (entityplayer.capabilities.disableDamage || this.thrower instanceof EntityPlayer && !((EntityPlayer)this.thrower).func_96122_a(entityplayer))
                {
...
//            }
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		   if (FMLCommonHandler.instance().getEffectiveSide()==Side.CLIENT){
				...
				{
					PacketSpawnItem.spawnItem(Jimmynator.tomahawk.itemID, this.itemDamage,1, xTile, yTile, zTile);
					this.setDead();
				}
		   }
