...
public class ItemReaper extends ItemTool {
	...
	private void Useing(ItemStack par1ItemStack, World par2World,EntityPlayer par3EntityPlayer, float f) {
        ...
        par2World.playSoundAtEntity(par3EntityPlayer, "mob.ghast.scream", 1.0F, 1.0F / (new Random().nextFloat() * 0.4F + 1.2F));	        
	      ...
	      for (int k2 = 0; k2 < list.size(); k2++)
	      {
	        if (list.get(k2) instanceof EntityLiving&&!(list.get(k2) instanceof EntityEnderman))
	        {
	          ...
	          if(!par2World.isRemote){
	        	  par2World.spawnEntityInWorld(new EntityItem(par2World, entity.posX, entity.posY, entity.posZ,	 new ItemStack(Jimmynator.soul,1)));
