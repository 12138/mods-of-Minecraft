package Jimmynator.common.item.grim;
...
import Jimmynator.common.network.PacketSetPos;
...
public class ItemLucifer extends ItemSword {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World,
		...
		if(Jimmynator.proxy.isEquid(par3EntityPlayer, "grim"))
			this.inGrim=true;
		else
			this.inGrim=false;
		if(this.inGrim||par3EntityPlayer.capabilities.isCreativeMode){
			if(par3EntityPlayer.inventory.hasItem(Jimmynator.soul.itemID)){
		        ...
		        par3EntityPlayer.inventory.consumeInventoryItem(Jimmynator.soul.itemID);
