...
public class RenderStaffBall extends Render {
	...
	public void updateIcons(IconRegister par1IconRegister) {
		this.fire=par1IconRegister.registerIcon("Jimmynator:fire");
		this.ice=par1IconRegister.registerIcon("Jimmynator:ice");
		this.life=par1IconRegister.registerIcon("Jimmynator:life");
		this.death=par1IconRegister.registerIcon("Jimmynator:death");
	...
	private void renderball(Entity entity, double d0, double d1, double d2,
	   ...
	   if(i==1)
		   rendering(tessellator,fire);
      	 else if(i==2)
      		rendering(tessellator,ice);
      	 else if(i==3)
      		rendering(tessellator,life);
      	 else if(i==4)
      		rendering(tessellator,death);
